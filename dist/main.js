...
</html>`;o.srcdoc=p,i.maximized?(o.style.width="100%",o.style.height="100%"):(o.style.width=`${r.width}px`,o.style.height="100%",n.style.width=`${r.width+2}px`)}function w(e,i){let t=e.pip.querySelector(".pip-empty-state");t&&(t.style.display=i?"":"none"),e.iframe&&(e.iframe.style.display=i?"none":"")}function F(e,i){let t=window.editorManager;if(!t)return()=>{};let o=null,n=()=>d(e,i),r=()=>{o&&clearTimeout(o),o=setTimeout(()=>d(e,i),300)};return t.on("switch-file",n),t.on("file-content-changed",r),()=>{o&&clearTimeout(o),t.off("switch-file",n),t.off("file-content-changed",r)}}function W(e){try{let i=window.acode.require("sideButton");if(!i)return null;let t=i({text:"Preview",icon:"",onclick:e,backgroundColor:"#89b4fa",textColor:"#1e1e2e"});return t.show(),t}catch{return null}}function H(e,i,t){try{let o=window.acode.require("commands");if(!o)return;o.addCommand({name:"web-preview-pip.toggle",description:"Web Preview PiP: Toggle Preview",bindKey:{win:"Ctrl-Shift-P",mac:"Command-Shift-P"},exec:t.onToggle}),o.addCommand({name:"web-preview-pip.close",description:"Web Preview PiP: Force Close",bindKey:{win:"Ctrl-Shift-X",mac:"Command-Shift-X"},exec:t.onForceClose}),o.addCommand({name:"web-preview-pip.reset",description:"Web Preview PiP: Reset & Close",bindKey:{win:"Ctrl-Shift-R",mac:"Command-Shift-R"},exec:t.onForceReset})}catch{}}var y=class{constructor(){this.elements=null;this.sideButton=null;this.cleanupListeners=null;this.state=x()}async init(i,t,o){this.elements=S(this.state),this.elements&&(a(this.elements,this.state),z(this.elements,this.state,()=>l(this.state)),M(this.elements,this.state,{onMinimize:()=>{C(this.elements,this.state),l(this.state)},onMaximize:()=>{L(this.elements,this.state),l(this.state)},onClose:()=>this.hide()}),k(this.elements,this.state,()=>{l(this.state),d(this.elements,this.state)}),this.cleanupListeners=F(this.elements,this.state),this.sideButton=W(()=>this.toggle()),H(this.elements,this.state,{onToggle:()=>this.toggle(),onForceClose:()=>this.forceClose(),onForceReset:()=>this.forceReset()}))}async destroy(){var i,t;(i=this.cleanupListeners)==null||i.call(this),this.elements&&E(this.elements),(t=this.sideButton)==null||t.hide()}toggle(){this.state.visible?this.hide():this.show()}show(){this.elements&&(this.state.visible=!0,a(this.elements,this.state),this.elements.pip.style.display="",d(this.elements,this.state),l(this.state))}hide(){this.elements&&(this.state.visible=!1,this.elements.pip.style.display="none",l(this.state))}forceClose(){this.elements&&(T(this.elements,this.state),l(this.state))}forceReset(){this.state=b(),this.forceClose()}};if(window.acode){let e=new y;acode.setPluginInit(u.id,async(i,t,{cacheFileUrl:o,cacheFile:n})=>{e.baseUrl=i.endsWith("/")?i:`${i}/`,await e.init(t,n,o)}),acode.setPluginUnmount(u.id,()=>{e.destroy()})}})();

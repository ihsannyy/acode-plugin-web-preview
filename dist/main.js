"use strict";(()=>{var v={id:"acode.plugin.webpreviewpip",name:"Web Preview PiP",main:"main.js",version:"1.0.5",readme:"readme.md",changelogs:"changelogs.md",icon:"icon.png",files:[],minVersionCode:290,license:"MIT",keywords:["preview","web","html","pip","live","picture-in-picture"],price:0,author:{name:"ihsannyy",github:"ihsannyy"}};var u="web-preview-pip-state",g={visible:!1,minimized:!1,maximized:!1,x:20,y:80,width:350,height:250,viewport:"mobile"};function x(){let i={...g};try{let o=localStorage.getItem(u);if(o){let n=JSON.parse(o);Object.assign(i,n)}}catch{}i.visible=!1,i.minimized=!1,i.maximized=!1;let e=window.innerWidth-20,t=window.innerHeight-20;return i.width=Math.max(200,Math.min(i.width||350,e)),i.height=Math.max(150,Math.min(i.height||250,t)),i.x=Math.max(0,Math.min(i.x||20,e-100)),i.y=Math.max(0,Math.min(i.y||80,t-50)),i}function l(i){try{localStorage.setItem(u,JSON.stringify(i))}catch{}}function b(){try{localStorage.removeItem(u)}catch{}return{...g}}function P(){return`
    #web-preview-pip {
      position: fixed;
      z-index: 99999;
      background: #1e1e2e;
...
</html>`;o.srcdoc=p,e.maximized?(o.style.width="100%",o.style.height="100%"):(o.style.width=`${r.width}px`,o.style.height="100%",n.style.width=`${r.width+2}px`)}function y(i,e){let t=i.pip.querySelector(".pip-empty-state");t&&(t.style.display=e?"":"none"),i.iframe&&(i.iframe.style.display=e?"none":"")}function W(i,e){let t=window.editorManager;if(!t)return()=>{};let o=null,n=()=>d(i,e),r=()=>{o&&clearTimeout(o),o=setTimeout(()=>d(i,e),300)};return t.on("switch-file",n),t.on("file-content-changed",r),()=>{o&&clearTimeout(o),t.off("switch-file",n),t.off("file-content-changed",r)}}function F(i){try{let e=window.acode;if(!e)return null;let t=e.require("sidebarApps");return t?(t.add("eye","web-preview-pip","Web Preview",o=>{o.innerHTML=`<div style="padding:8px;text-align:center;cursor:pointer;">
          <span class="icon eye" style="font-size:24px;"></span>
          <div style="font-size:11px;margin-top:4px;">Preview</div>
        </div>`,o.style.cursor="pointer",o.addEventListener("click",i)},!1,()=>{}),{remove:()=>{try{t.remove("web-preview-pip")}catch{}}}):null}catch(e){return console.error("Web Preview PiP: Failed to register sidebar app",e),null}}function H(i,e,t){try{let o=window.acode.require("commands");if(!o)return;o.addCommand({name:"web-preview-pip.toggle",description:"Web Preview PiP: Toggle Preview",bindKey:{win:"Ctrl-Shift-V",mac:"Command-Shift-V"},exec:t.onToggle}),o.addCommand({name:"web-preview-pip.close",description:"Web Preview PiP: Force Close",bindKey:{win:"Ctrl-Shift-Q",mac:"Command-Shift-Q"},exec:t.onForceClose}),o.addCommand({name:"web-preview-pip.reset",description:"Web Preview PiP: Reset & Close",bindKey:{win:"Ctrl-Shift-;",mac:"Command-Shift-;"},exec:t.onForceReset})}catch{}}var w=class{constructor(){this.elements=null;this.sidebarApp=null;this.cleanupListeners=null;this.state=x()}async init(e,t,o){this.elements=S(this.state),this.elements&&(a(this.elements,this.state),z(this.elements,this.state,()=>l(this.state)),M(this.elements,this.state,{onMinimize:()=>{L(this.elements,this.state),l(this.state)},onMaximize:()=>{C(this.elements,this.state),l(this.state)},onClose:()=>this.hide()}),k(this.elements,this.state,()=>{l(this.state),d(this.elements,this.state)}),this.cleanupListeners=W(this.elements,this.state),this.sidebarApp=F(()=>this.toggle()),H(this.elements,this.state,{onToggle:()=>this.toggle(),onForceClose:()=>this.forceClose(),onForceReset:()=>this.forceReset()}))}async destroy(){var e,t;(e=this.cleanupListeners)==null||e.call(this),this.elements&&E(this.elements),(t=this.sidebarApp)==null||t.remove()}toggle(){this.state.visible?this.hide():this.show()}show(){this.elements&&(this.state.visible=!0,a(this.elements,this.state),this.elements.pip.style.display="",d(this.elements,this.state),l(this.state))}hide(){this.elements&&(this.state.visible=!1,this.elements.pip.style.display="none",l(this.state))}forceClose(){this.elements&&(T(this.elements,this.state),l(this.state))}forceReset(){this.state=b(),this.forceClose()}};if(window.acode){let i=new w;acode.setPluginInit(v.id,async(e,t,{cacheFileUrl:o,cacheFile:n})=>{i.baseUrl=e.endsWith("/")?e:`${e}/`,await i.init(t,n,o)}),acode.setPluginUnmount(v.id,()=>{i.destroy()})}})();
